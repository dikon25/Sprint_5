...
def test_enter_account_from_main_page_show_main_page(driver):
...
def test_enter_account_from_button_personal_account_page_show_main_page(driver):
    driver.get(Data_url.url_main_paige)
...
def test_enter_account_from_button_regestr_form_show_main_page(driver):
...
def test_enter_account_from_recovery_pass_show_main_page(driver):
    driver.get(Data_url.url_login)
